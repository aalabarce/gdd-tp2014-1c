...
as
SELECT PUB_ID As Publicacion, OFE_USU_ID As Ganador, OFE_ID
...
as
SELECT PUB_ID, COM_ID as COM_OFE_ID, PUB_DESCRIPCION As Publicacion, USU_USERNAME As Comprador, COM_FECHA As Fecha
FROM STR_NOMBRE_GRUPO.PUBLICACION
JOIN STR_NOMBRE_GRUPO.COMPRA ON COM_PUB_ID=PUB_ID
JOIN STR_NOMBRE_GRUPO.USUARIO ON COM_USU_ID=USU_ID
WHERE COM_CAL_ID is null
UNION
SELECT PUB_ID, o.OFE_ID as COM_OFE_ID, PUB_DESCRIPCION As Publicacion, USU_USERNAME As Comprador, OFE_FECHA As Fecha
FROM STR_NOMBRE_GRUPO.SUBASTAS_GANADORES
JOIN STR_NOMBRE_GRUPO.OFERTA o ON OFE_USU_ID=Ganador
