...
as
SELECT p.PUB_ID, USU_USERNAME as Usuario, Año, Trimestre, Stock-SUM(COM_CANTIDAD) as CANT_SIN_VENDER
FROM 
(SELECT PUB_ID, CASE PUB_TIPO_ID WHEN 'C' THEN PUB_STOCK ELSE 1 END As Stock, COM_CANTIDAD, YEAR(PUB_FECHA_INICIO) as Año,
...
GROUP BY p.PUB_ID, USU_USERNAME, Año, Trimestre, Stock
