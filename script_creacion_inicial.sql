...
as
SELECT USU_USERNAME AS Usuario, PUB_DESCRIPCION AS Publicacion, OFE_FECHA AS Fecha, OFE_CAL_ID AS Calificacion, OFE_MONTO AS Monto
...
UNION
SELECT USU_USERNAME, PUB_DESCRIPCION, OFE_FECHA, CAL_CANT_ESTRELLAS, OFE_MONTO
FROM STR_NOMBRE_GRUPO.OFERTA
JOIN STR_NOMBRE_GRUPO.PUBLICACION ON OFE_PUB_ID=PUB_ID
JOIN STR_NOMBRE_GRUPO.USUARIO ON OFE_USU_ID=USU_ID
