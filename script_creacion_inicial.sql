...
left outer JOIN STR_NOMBRE_GRUPO.SUBASTAS_GANADORES b ON b.Publicacion=PUB_ID
...
/*
--Compras directas sin calificar
SELECT PUB_ID As Publicacion, COM_USU_ID As Comprador
FROM STR_NOMBRE_GRUPO.PUBLICACION
JOIN STR_NOMBRE_GRUPO.COMPRA ON COM_PUB_ID=PUB_ID
WHERE COM_CAL_ID is null AND PUB_ESTADO_ID='F'

--Subastas sin calificar
SELECT PUB_ID As Publicacion, s.OFE_USU_ID As Comprador
FROM STR_NOMBRE_GRUPO.SUBASTAS_GANADORES s
JOIN STR_NOMBRE_GRUPO.OFERTA o ON o.OFE_USU_ID=s.Ganador
