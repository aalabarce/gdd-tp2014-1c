...
--MIGRACIÓN DE DATOS
	...
	INSERT INTO STR_NOMBRE_GRUPO.CLIENTE(CLI_DOC,CLI_USU_ID,CLI_NOMBRE,CLI_APE,CLI_TIPO_DOC,CLI_MAIL,CLI_TELEFONO,CLI_CALLE,CLI_CALLE_NRO,CLI_PISO,CLI_DEPTO,CLI_LOCALIDAD,CLI_COD_POSTAL,CLI_FECHA_NAC)
 	...
 	INSERT INTO STR_NOMBRE_GRUPO.USUARIO(USU_USERNAME,USU_PASSWORD,USU_INTENTOS_LOGIN,USU_TIPO)
			SELECT CLI_DOC, HASHBYTES('SHA2_256',CLI_APE),0,'C'
	...
	INSERT INTO STR_NOMBRE_GRUPO.USUARIO(USU_USERNAME,USU_PASSWORD,USU_INTENTOS_LOGIN,USU_TIPO)
			SELECT EMP_CUIT, HASHBYTES('SHA2_256',EMP_RAZON_SOCIAL),0,'E'
...
as
SELECT usu2.USU_USERNAME AS Vendedor, usu1.USU_USERNAME AS Comprador, PUB_DESCRIPCION AS Publicacion, OFE_FECHA AS Fecha, CAL_CANT_ESTRELLAS AS Calificacion, OFE_MONTO AS Monto
...
SELECT PUB_ID, COM_USU_ID
FROM STR_NOMBRE_GRUPO.PUBLICACION
JOIN STR_NOMBRE_GRUPO.COMPRA ON COM_PUB_ID=PUB_ID
WHERE COM_CAL_ID is null

--Subastas sin calificar
SELECT PUB_ID, s.OFE_USU_ID
FROM STR_NOMBRE_GRUPO.SUBASTAS_GANADORES s
JOIN STR_NOMBRE_GRUPO.OFERTA o ON o.OFE_USU_ID=s.OFE_USU_ID
WHERE o.OFE_CAL_ID is null
*/
