...
namespace FrbaCommerce.Comprar_Ofertar
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void bindingSource1_CurrentChanged(object sender, EventArgs e)
        {
            ...
            {
                // Agregar al datagrid los valores de la tabla en la posicion i
                DataRow FilaAModificar = gD1C2014DataSet.PUBLICACION.NewRow();
                FilaAModificar = gD1C2014DataSet.PUBLICACION.FindByPUB_ID(12353);
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            this.pUBLICACIONTableAdapter.Fill(this.gD1C2014DataSet.PUBLICACION);
